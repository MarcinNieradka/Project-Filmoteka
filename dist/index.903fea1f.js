...
})({"9jo5f":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "3b11a5dc903fea1f";
"use strict";
...
},{}],"hTBkT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderMovies", ()=>renderMovies);
var _refs = require("./refs");
var _modal = require("./modal"); //importujemy funkcję, żeby użyć jej w tym pliku
var _genres = require("./genres");
var _makeMoviePoster = require("./makeMoviePoster");
const { galleryEl  } = (0, _refs.refs);
const renderMovies = (dataMovies)=>{
    ...
    dataMovies.forEach((movie)=>{
        ...
        // }
        let releaseDate = "";
        if (movie.release_date === "") releaseDate = "No release date assigned";
        else releaseDate = movie.release_date.slice(0, 4);
        movieContainer.innerHTML = `
    <img class="gallery__movie-poster" src="${(0, _makeMoviePoster.makeMoviePoster)(movie)}" alt="${movie.title} poster" 
    width="500" height="auto"/>
    <h3 class="gallery__movie-title">${movie.title}</h3>
    <p class="gallery__movie-genres">
    ${(0, _genres.makeGenresList)(movie)} <i class="fa-sharp fa-solid fa-video"></i> ${releaseDate}</p>`;
        galleryEl.appendChild(movieContainer);
        const imageButtons = movieContainer.querySelectorAll(".gallery__movie-poster");
        imageButtons.forEach((imageButton)=>{
            imageButton.addEventListener("click", ()=>(0, _modal.imageButtonClick)(movie)); // tu już była sama deklaracja, definicje można było eksportować
        });
    });
};

},{"./refs":"2WoF2","./modal":"aHHgN","./genres":"2f7DF","./makeMoviePoster":"iRJhg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2WoF2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "imageButtonClick", ()=>imageButtonClick);
var _fetchMovies = require("./fetchMovies");
// import { idToGenre } from './genres';
var _refs = require("./refs");
var _localStorage = require("./localStorage");
var _makeMoviePoster = require("./makeMoviePoster");
var _genres = require("./genres");
var _reloadLibrary = require("./reloadLibrary");
function imageButtonClick(movie) {
    ...
    <div class="modal-content__movie-poster-container">
      <img class="modal-content__movie-poster" src="${(0, _makeMoviePoster.makeMoviePoster)(movie)}"/>
      </div>
        <h3 class="modal-content__movie-title">${movie.title}</h3>
        <ul class="modal-content__list">
        <div class="modal-content__list-box-1">
        <li>Vote / Votes</li>
        <li class="modal-content__list-result"><span class="text-transform-1">${Math.round(movie.vote_average).toFixed(1)}</span> / <span class="text-transform-2"> ${movie.vote_count}</span></li>
        ...
        <li>Genre</li>
        <li class="modal-content__list-result">${(0, _genres.makeGenresList)(movie)}</li>
        </div>
        </ul>
    ...
    modal1.classList.remove("is-hidden-modal");
    modal1.addEventListener("click", handleEvent);
    ...
    function playTrailer() {
        (0, _fetchMovies.fetchID)(movie.id, "/videos").then((videoData)=>{
        ...
        `;
            } else buttonPoster.classList.add("modal-content__movie-poster-container__no-trailer");
        }).catch((error)=>{
    ...
    function addWatchedClick() {
        ...
        if ((0, _localStorage.watched).includes(movie.id)) {
    ...
    function watchedToStorage() {
        if ((0, _localStorage.watched).includes(movie.id)) {
            (0, _localStorage.watched).splice((0, _localStorage.watched).indexOf(movie.id), 1);
            (0, _localStorage.setWatched)((0, _localStorage.watched));
            watchedBtn.textContent = "add to watched";
            // reloadLibOnly();
            (0, _reloadLibrary.reloadWatchedOnly)();
            handleModalClose();
            return;
        }
        (0, _localStorage.watched).push(movie.id);
        (0, _localStorage.setWatched)((0, _localStorage.watched));
        watchedBtn.textContent = "remove from watched";
    }
    //add to queue btn -->
    ...
    function addQueueClick() {
        ...
        if ((0, _localStorage.queue).includes(movie.id)) {
    ...
    function queueToStorage() {
        if ((0, _localStorage.queue).includes(movie.id)) {
            (0, _localStorage.queue).splice((0, _localStorage.queue).indexOf(movie.id), 1);
            (0, _localStorage.setQueue)((0, _localStorage.queue));
            queueBtn.textContent = "add to queue";
            // alert('here');
            // reloadLibOnly();
            (0, _reloadLibrary.reloadQueueOnly)();
            handleModalClose();
            return;
        }
        (0, _localStorage.queue).push(movie.id);
        (0, _localStorage.setQueue)((0, _localStorage.queue));
        queueBtn.textContent = "remove from queue";
    }
...
function handleEvent(event) {
    if (event.type === "click" && event.target.closest(".modal-content") === null && event.target.closest(".button-modal-close") === null) {
        modal.innerHTML = "";
        modal.classList.add("is-hidden-modal");
        enableScroll();
        window.removeEventListener("keydown", handleEvent);
...
},{"./fetchMovies":"34BkJ","./refs":"2WoF2","./localStorage":"45bAM","./makeMoviePoster":"iRJhg","./genres":"2f7DF","./reloadLibrary":"brJMY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"34BkJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchSearchFlag", ()=>fetchSearchFlag);
parcelHelpers.export(exports, "totalPages", ()=>totalPages);
parcelHelpers.export(exports, "fetchMovies", ()=>fetchMovies);
parcelHelpers.export(exports, "fetchSearch", ()=>fetchSearch);
parcelHelpers.export(exports, "fetchID", ()=>fetchID);
parcelHelpers.export(exports, "fetchTrending", ()=>fetchTrending);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
// import { renderMovies } from './gallery';
var _renderMovies = require("./renderMovies");
var _modal = require("./modal");
let fetchSearchFlag = false;
...
const fetchMovies = async (url)=>{
    try {
        ...
        (0, _renderMovies.renderMovies)(response.data.results);
    } catch (error) {
        console.log(error);
    }
};
const fetchSearch = async (query, page)=>{
    ...
    const response = await (0, _axiosDefault.default).get(`${URL}${SEARCH_URL}`, {
        params: {
            query: query,
            api_key: KEY,
            language: LANG,
...
const fetchID = async (id, video)=>{
    !video ? video = "" : video = "/videos";
    const response = await (0, _axiosDefault.default).get(`${URL}movie/${id}${video}`, {
        params: {
            api_key: KEY,
            language: LANG,
            include_adult: false
...
const fetchTrending = async ()=>{
    const response = await (0, _axiosDefault.default).get(`${URL}trending/movie/week`, {
        params: {
            api_key: KEY,
            language: LANG,
            include_adult: false
    ...
    const data = await response.data;
    (0, _renderMovies.renderMovies)(data.results);
...
},{"axios":"jo6P5","./renderMovies":"hTBkT","./modal":"aHHgN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var Buffer = require("73d6b86998cb07d5").Buffer;
"use strict";
/**
...
},{"73d6b86998cb07d5":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("925be187ee94f1fb");
var ieee754 = require("81f7e97becc59e97");
...
},{"925be187ee94f1fb":"eIiSV","81f7e97becc59e97":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
parcelHelpers.export(exports, "setQueue", ()=>setQueue);
parcelHelpers.export(exports, "getWatched", ()=>getWatched);
parcelHelpers.export(exports, "getQueue", ()=>getQueue);
const KEY_WATCHED = "watched";
const KEY_QUEUE = "queue";
const watched = getWatched() || [];
const queue = getQueue() || [];
function setWatched(array) {
    localStorage.setItem(KEY_WATCHED, JSON.stringify(array));
}
function setQueue(array) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iRJhg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "makeMoviePoster", ()=>makeMoviePoster);
const IMG_URL = "https://image.tmdb.org/t/p/w500";
function makeMoviePoster(movie) {
    let moviePoster = "";
    if (movie.poster_path === null) return moviePoster = new URL(require("dbe6da852460a1b8"));
    else return moviePoster = `${IMG_URL}${movie.poster_path}`;
}

},{"dbe6da852460a1b8":"eahN3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eahN3":[function(require,module,exports) {
module.exports = require("307714406e1ec6e4").getBundleURL("54qcl") + "poster-none.9b3cf9a5.png" + "?" + Date.now();

},{"307714406e1ec6e4":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"2f7DF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "genres", ()=>genres);
parcelHelpers.export(exports, "idToGenre", ()=>idToGenre);
parcelHelpers.export(exports, "makeGenresList", ()=>makeGenresList);
const genres = [
    {
        id: 28,
        name: "Action"
...
function makeGenresList(movie) {
    let genresList = "";
    if (movie.genre_ids.length === 0) return genresList = "No genres assigned";
    else return genresList = idToGenre(movie.genre_ids);
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"brJMY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "reloadWatchedOnly", ()=>reloadWatchedOnly);
parcelHelpers.export(exports, "reloadQueueOnly", ()=>reloadQueueOnly);
...
function reloadWatchedOnly() {
    if (currentPage == homePage) //   console.log('currentPage run');
    watchedBtnLib.classList.add("watched-hidden");
    if (currentPage == libraryPage.href) (0, _library.watchedBtnLibClick)();
}
function reloadQueueOnly() {
    if (currentPage == homePage) queueBtnLib.classList.add("queue-hidden");
    if (currentPage == libraryPage.href) (0, _library.queueBtnLibClick)();
}
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "watchedBtnLibClick", ()=>watchedBtnLibClick);
parcelHelpers.export(exports, "queueBtnLibClick", ()=>queueBtnLibClick);
var _refs = require("./refs");
var _localStorage = require("./localStorage");
var _fetchMovies = require("./fetchMovies");
var _renderMovies = require("./renderMovies");
...
window.addEventListener("load", ()=>{
    ...
    if (currentPage == libraryPage) {
        ...
        watchedBtnLibClick();
        queueBtnLib.innerHTML = `QUEUE: ${(0, _localStorage.queue).length}`;
    }
...
function watchedBtnLibClick() {
    if ((0, _localStorage.watched).length === 0) {
    ...
    if (divGallery.innerHTML = (0, _localStorage.queue)) {
        divGallery.innerHTML = "";
        libQueue.classList.add("is-hidden");
    }
    showWatchedMovies((0, _localStorage.watched));
    watchedBtnLib.innerHTML = `WATCHED: ${(0, _localStorage.watched).length}`;
    toggleSound.play();
}
// get watched form local storage and shows
function showWatchedMovies() {
    (0, _localStorage.watched).forEach((id)=>{
        (0, _fetchMovies.fetchID)(id).then((data)=>{
            const genreArr = data.genres.map((genre)=>genre.id);
            data.genre_ids = genreArr;
            (0, _renderMovies.renderMovies)([
                data
            ]);
...
},{"./refs":"2WoF2","./localStorage":"45bAM","./fetchMovies":"34BkJ","./renderMovies":"hTBkT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eHqPO":[function(require,module,exports) {
...
},{}]},["9jo5f"], null, "parcelRequired7c6")

//# sourceMappingURL=index.903fea1f.js.map
