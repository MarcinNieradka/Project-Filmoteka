...
})({"bI2RD":[function(require,module,exports) {
...
var _headerLibrary = require("./js/headerLibrary");
var _renderMovies = require("./js/renderMovies");
// import './js/loader';
var _library = require("./js/library");
var _modalTeam = require("./js/modalTeam");

},{"./sass/main.scss":"dFl68","./js/headerLibrary":"aKB6e","./js/renderMovies":"hTBkT","./js/library":"98Wmb","./js/modalTeam":"eHqPO"}],"dFl68":[function() {},{}],"aKB6e":[function(require,module,exports) {
let lastScrollTop = 0;
let header = document.querySelector(".header");
window.addEventListener("scroll", ()=>{
    let scrollTop = window.pageYOffset || document.documentElement.scrollTop;
    if (scrollTop > lastScrollTop) header.style.top = "-260px";
...
},{}]},["bI2RD","iN9ma"], "iN9ma", "parcelRequired7c6")
